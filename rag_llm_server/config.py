...
================================================================
【开门见山】本模块负责把散落在 .env 文件里的"键值对"读取进来，
           变成代码里可以直接用的"属性"，就像一个"配置中转站"。

【生活比喻】
    想象你去一家餐厅工作：
    - .env 文件就像是员工手册，上面写着密码和账号
    - config.py 就像是前台的服务员，帮你把这些信息整理好
    - 其他模块来前台问："AK是什么？SK是什么？"
    - 前台从员工手册里查好，告诉他们
...
class Config:
    ...
    【生活比喻】
        就像酒店前台把所有服务信息整理成一本小册子：
        - 房间清洁服务找"客房部"配置
        - 订餐服务找"餐饮部"配置
        - 叫车服务找"礼宾部"配置
        不用每次都去翻厚厚的员工手册，直接翻小册子就行。
